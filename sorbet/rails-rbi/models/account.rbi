...
# typed: strong
module Account::EnumInstanceMethods
  extend T::Sig
...
class Account < ApplicationRecord
  include Account::EnumInstanceMethods
  ...
  def self.google_oauth2(*args); end

  sig { params(args: T.untyped).returns(Account::ActiveRecord_Relation) }
  def self.not_google_oauth2(*args); end
...
class Account::ActiveRecord_Relation < ActiveRecord::Relation
  ...
  sig { params(args: T.untyped).returns(Account::ActiveRecord_Relation) }
  def google_oauth2(*args); end

  sig { params(args: T.untyped).returns(Account::ActiveRecord_Relation) }
  def not_google_oauth2(*args); end
