...
gem 'puma', '~> 5.4.0' # Use Puma as the application server
gem 'rails', '~> 6.1.3'
...
gem 'flipper-active_record', '~> 0.22.0' # ActiveRecord adapter for flipper
...
group :development, :test do
  ...
  gem 'license_finder', '~> 6.14.1' # license checking
